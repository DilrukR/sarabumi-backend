...
class GetCategoriesDto extends pagination_args_dto_1.PaginationArgs {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { orderBy: { required: false, enum: require("./get-categories.dto").QueryCategoriesOrderByColumn }, sortedBy: { required: false, enum: require("../../common/dto/generic-conditions.dto").SortOrder }, search: { required: false, type: () => String }, parent: { required: false, type: () => Number, default: null } };
    }
}
