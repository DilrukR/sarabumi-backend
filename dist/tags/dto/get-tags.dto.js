...
class GetTagsDto extends pagination_args_dto_1.PaginationArgs {
    static _OPENAPI_METADATA_FACTORY() {
        return { orderBy: { required: false, enum: require("./get-tags.dto").QueryTagsOrderByColumn }, sortedBy: { required: false, enum: require("../../common/dto/generic-conditions.dto").SortOrder }, text: { required: false, type: () => String }, name: { required: false, type: () => String }, hasType: { required: false, type: () => String } };
    }
}
